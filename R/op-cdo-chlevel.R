...
#' @export
#' @rdname change
cdo_chlevel <- function(ifile, code = NULL, oldcode = NULL, newcode = NULL, oldparam = NULL, newparam = NULL, name = NULL, oldname = NULL, newname = NULL, oldlev = NULL, newlev = NULL, ofile = NULL) {
  cdo(operator = operators$chlevel,
      input = list(ifile),
