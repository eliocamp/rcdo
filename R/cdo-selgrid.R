...
#'
#' @export
cdo_selgrid <- function(ifile, parameter = NULL, codes = NULL, names = NULL, stdnames = NULL, levels = NULL, levidx = NULL, ltypes = NULL, grids = NULL, zaxes = NULL, zaxisnames = NULL, tabnums = NULL, ofile = NULL) {
  cdo(operator = operators$selgrid,
      input = list(ifile),
