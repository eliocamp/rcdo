...
#' @export
#' @rdname settime
cdo_setdate <- function(ifile, day = NULL, month = NULL, year = NULL, units = NULL, date = NULL, time = NULL, inc = NULL, frequency = NULL, calendar = NULL, shiftValue = NULL, ofile = NULL) {
  cdo(operator = operators$setdate,
      input = list(ifile),
