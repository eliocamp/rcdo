...
#'
#' @export
cdo_setcodetab <- function(ifile, table = NULL, code = NULL, param = NULL, name = NULL, level = NULL, ltype = NULL, maxsteps = NULL, ofile = NULL) {
  cdo(operator = operators$setcodetab,
      input = list(ifile),
