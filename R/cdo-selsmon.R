...
#' @export
#' @rdname seltime
cdo_selsmon <- function(ifile, timesteps = NULL, times = NULL, hours = NULL, days = NULL, months = NULL, years = NULL, seasons = NULL, startdate = NULL, enddate = NULL, nts1 = NULL, nts2 = NULL, ofile = NULL) {
  cdo(operator = operators$selsmon,
      input = list(ifile),
