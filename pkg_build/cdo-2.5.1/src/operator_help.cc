...
const CdoHelp YdrunpctlHelp = {
    ...
    "    nts    INTEGER  Number of timesteps",
    "    rm=c   STRING   Read method circular",
    "    pm=r8  STRING   Percentile method rtype8",
    "",
    "ENVIRONMENT",
    "    CDO_PCTL_NBINS",
    "        Sets the number of histogram bins. The default number is 101.",
...
const CdoHelp TimcorHelp = {
    ...
    "",
    "DESCRIPTION",
    "    The correlation coefficient is a quantity that gives the quality of a least squares fitting",
    "    to the original data. This operator correlates each gridpoint of two fields over all timesteps.",
    "    If there is only one input field, the p-value (probability value) is also written out.",
    "    With",
    "    ",
...
const CdoHelp WctHelp = {
    ...
    "    speed fields, then a corresponding time series of resulting windchill",
    ...
    "    value is written to outfile. Note that temperature and wind speed fields",
