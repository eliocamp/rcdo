...
infile1 to outfile. The algorithm uses histograms with minimum and
...
ymonmin and ymonmax operations, respectively. The date information in an
output field is the date of the last contributing input field. o(01,x) =
pth percentile {i(t,x), month(i(t)) = 01} ... o(12,x) = pth percentile
{i(t,x), month(i(t)) = 12}
